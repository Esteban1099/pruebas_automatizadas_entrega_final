...
Then('I select first tag option', async function () {
  ...
  Then('I click first user', async function () {
    let element = await this.driver.$('.gh-active-users > .apps-grid > div:nth-child(2)');
    return await element.click();
  })

  Then('I enter staff name {kraken-string}', async function (string) {
...
Then('I click settings menu', async function () {
  let element = await this.driver.$('.gh-nav-bottom > .ember-view > div');
  return await element.click();
})

Then('I click my profile', async function () {
  let element = this.driver.$("ul.dropdown-menu > li > a[href^='#/staff/']");
  return await element.click();
})

Then('I enter website {kraken-string}', async function(string) {
  let element = this.driver.$('input#user-website');
  return await element.setValue(string);
})
  ...
  Then('I enter tag color', async function () {
    let element = await this.driver.$('.input-color > input')
    return await element.setValue("FF9A00");
  })